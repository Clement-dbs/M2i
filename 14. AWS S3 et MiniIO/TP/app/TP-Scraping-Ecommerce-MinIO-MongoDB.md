...
1. Quelles sont les catégories de produits disponibles ?
    # Laptop, Tablets, Touch
2. Comment fonctionne la pagination ?
    # La pagination fonctionne par catégorie, puis sous catégorie
3. Quelles informations sont disponibles sur la page liste vs page détail ?
    # page liste : Le titre et une description
    # page detail : davantage de description sur le produit
...
|--------|---------------|-------------------|
| Titre du produit | <a href="/test-sites/e-commerce/allinone/product/107" class="title" title="Lenovo Legion Y520" itemprop="name">Lenovo Legion...</a> |Lenovo Legion 
| Prix | <span itemprop="price">$1133.91</span> | $1133.91 |
| Description | <p class="description card-text" itemprop="description">Lenovo Legion Y520, 15.6" FHD, Core i7-7700HQ, 8GB, 128 GB SSD + 1TB HDD, GTX 1050 4GB, Windows 10 Home< p> |Lenovo Legion Y520, 15.6" FHD, Core i7-7700HQ, 8GB, 128 GB SSD + 1TB HDD, GTX 1050 4GB, Windows 10 Home |
| Rating (étoiles) | <span class="ws-icon ws-icon-star"></span> | 1|
| URL de l'image | <img class="img-fluid card-img-top image img-responsive" alt="item" src="/images/test-sites/e-commerce/items/cart2.png" itemprop="image">| |
| Lien vers détails | <a href="/test-sites/e-commerce/allinone/product/107" class="title" title="Lenovo Legion Y520" itemprop="name">Lenovo Legion...</a>| |
